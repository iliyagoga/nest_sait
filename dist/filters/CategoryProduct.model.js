...
let CategoryProduct = class CategoryProduct extends sequelize_typescript_1.Model {
};
...
], CategoryProduct.prototype, "id", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], CategoryProduct.prototype, "productId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1', description: 'id категории' }),
    (0, sequelize_typescript_1.ForeignKey)(() => category_model_1.Category),
    (0, sequelize_typescript_1.Column)({ type: sequelize_1.DataTypes.INTEGER }),
    __metadata("design:type", Number)
], CategoryProduct.prototype, "categoryId", void 0);
exports.CategoryProduct = CategoryProduct = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "CategoryProduct" })
], CategoryProduct);
