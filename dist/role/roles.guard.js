...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        try {
            const requiredRoles = this.reflector.getAllAndOverride(roles_auth_decoration_1.ROLES_KEY, [
                context.getHandler(),
                context.getClass()
            ]);
            if (!requiredRoles) {
            ...
            console.log(error);
            throw new common_1.HttpException({ message: "Нет доступа" }, common_1.HttpStatus.BAD_REQUEST);
        }
    }
};
