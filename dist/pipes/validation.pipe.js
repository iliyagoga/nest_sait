...
let ValidationPipe = class ValidationPipe {
    async transform(value, metadata) {
        ...
        if (errors.length) {
            throw new validation_exception_1.ValidationException({ messages: errors.map((v) => { return { type: v.property, value: Object.values(v.constraints) }; }), status: common_1.HttpStatus.BAD_REQUEST });
        }
        return value;
    }
};
