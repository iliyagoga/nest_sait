...
let Colors = class Colors extends sequelize_typescript_1.Model {
};
...
], Colors.prototype, "title", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_1.DataTypes.TEXT, allowNull: false, unique: true }),
    __metadata("design:type", String)
], Colors.prototype, "value", void 0);
exports.Colors = Colors = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "Colors" })
], Colors);
