...
let Previews = class Previews extends sequelize_typescript_1.Model {
};
exports.Previews = Previews;
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1', description: 'id изображения' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_1.DataTypes.INTEGER, unique: true, autoIncrement: true, primaryKey: true }),
    __metadata("design:type", Number)
], Previews.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'img.png', description: 'Название изображения' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_1.DataTypes.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Previews.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1', description: 'id продукта' }),
    (0, sequelize_typescript_1.ForeignKey)(() => product_model_1.Product),
    __metadata("design:type", Number)
], Previews.prototype, "productId", void 0);
exports.Previews = Previews = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'Previews' })
], Previews);
